...
//
// What stays: channel_reads cursors and channel_seq. Sequence numbers keep
// climbing across a purge, so an old cursor stays correctly "behind" whatever
// the next call writes rather than marking it unread.
