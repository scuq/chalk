...
#voice          30 41 44 45 47 63 66 70 71 95 96 97 103 109 118 119 120 122 123 126  internal/turncred/ internal/proto/voice.go internal/server/voice_ws.go internal/store/voice.go web/src/voice/ web/src/voice/duration.ts web/src/components/VoiceCallPanel.tsx web/src/components/VoiceControls.tsx web/src/components/VoiceDock.tsx web/src/theme.css web/src/theme-voice-pane.test.ts web/src/theme-sidebar.test.ts docs/phases/PHASE-30-VOICE.md docs/phases/PHASE-41-MICROPHONE.md docs/phases/PHASE-44-VOICEPANEL.md docs/phases/PHASE-63-CALLTILES.md docs/phases/PHASE-66-CALLPREFS.md docs/phases/PHASE-95-PHONEVOICE.md docs/phases/PHASE-96-CALLSTAGE.md docs/phases/PHASE-97-VOICEDIAG.md docs/phases/PHASE-103-CAMERAOFF.md docs/phases/PHASE-109-DEAFENED.md docs/phases/PHASE-118-POPOUTTOP.md docs/phases/PHASE-119-BOOST.md docs/phases/PHASE-120-BOARD.md docs/phases/PHASE-122-MICSWAP.md docs/phases/PHASE-123-SIDEBARFLOOR.md docs/phases/PHASE-126-ZUCKERCALL.md docs/design/chalk-phase-30-voice-video-design.md
...
#notify         40 50 71 102  web/src/notify/ web/assets/sounds/ web/src/components/ProfilePanel.tsx tools/render-classic-theme.mjs internal/server/spa.go docs/notification-sounds.md docs/phases/PHASE-40-SOUNDS.md docs/phases/PHASE-50-NOTIFYRULES.md docs/phases/PHASE-71-CALLSOUNDS.md docs/phases/PHASE-102-SOUNDTHEMES.md
...
#roster         54 78 92 100 106 114 123  web/src/chat/ web/src/components/Sidebar.tsx web/src/components/HoverCard.tsx web/src/components/ZuckerList.tsx web/src/components/CreateChannelModal.tsx web/src/theme.css web/src/theme-sidebar.test.ts docs/phases/PHASE-54-ROSTER.md docs/phases/PHASE-78-HIDECHANNELS.md docs/phases/PHASE-92-HOVERCARD.md docs/phases/PHASE-100-VOICESECTION.md docs/phases/PHASE-123-SIDEBARFLOOR.md
...
#zucker         62 64 78 95 126  web/src/chat/zucker.ts web/src/components/ZuckerList.tsx web/src/components/ZuckerCallBar.tsx web/src/theme.css web/src/theme-zucker.test.ts docs/phases/PHASE-62-ZUCKER.md docs/phases/PHASE-78-HIDECHANNELS.md docs/phases/PHASE-95-PHONEVOICE.md docs/phases/PHASE-126-ZUCKERCALL.md
...
#nanomd         77 107    web/src/chat/nanomd.ts web/src/components/MessageList.tsx web/src/theme.css docs/phases/PHASE-77-NANOMD.md docs/phases/PHASE-107-QUOTE.md
...
#typing         43        internal/server/ web/src/state/ web/src/components/TypingLine.tsx web/src/chat/typing.ts web/src/chat/wave.ts web/src/components/ProfilePanel.tsx web/src/theme.css docs/phases/PHASE-43-TYPING.md
...
#mobile         32 60 64 76 94 125  web/src/mobile.ts web/src/chat/swipe-back.ts web/src/chat/use-swipe-back.ts web/src/chat/press.ts web/src/components/ web/src/theme.css web/src/viewport.ts docs/phases/PHASE-32-MOBILE.md docs/phases/PHASE-60-MOBILEFIT.md docs/phases/PHASE-64-SWIPEBACK.md docs/phases/PHASE-94-PHONECOMPOSER.md docs/phases/PHASE-125-KEYBOARD.md
...
#avatar         112       migrations/0060_channel_avatars.sql internal/store/avatars.go internal/server/avatars_ws.go internal/server/avatar_event.go web/src/attachments/avatar.ts web/src/avatars/ web/src/components/Avatar.tsx docs/phases/PHASE-112-AVATARS.md
#banner         111       migrations/0056_channel_banner.sql migrations/0057_channel_banner_fit.sql migrations/0058_channel_banner_layout.sql migrations/0059_channel_banner_shapes.sql internal/store/channel_banner.go web/src/attachments/banner-edges.ts web/src/attachments/use-banner-image.ts web/src/state/banner.ts web/src/components/BannerBand.tsx web/src/components/BannerEditor.tsx web/src/components/BannerCropper.tsx web/src/attachments/crop.ts internal/store/channel_names.go internal/store/channels.go internal/store/attachments.go internal/auth/attachments_http.go internal/server/channel_names_ws.go web/src/attachments/banner.ts web/src/components/ChannelBanner.tsx web/src/components/Sidebar.tsx web/src/display-prefs.ts web/src/theme.css docs/phases/PHASE-111-BANNER.md
