# Phase 107 — quoting a message

**Numbering:** built and submitted as phase 99 (PR #9, torlenor, 2026-08-09; its commit messages say `99-N`), renumbered to 107 at merge on 2026-08-28 because 99 was already claimed by [PHASE-99-DBCREDS.md](PHASE-99-DBCREDS.md).

**Status:** shipped. 107-1 the rules, 107-2 the render, 107-3 the action, 107-4
