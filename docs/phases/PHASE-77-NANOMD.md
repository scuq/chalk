...
**Status:** shipped, v0.6.2. Extended by phase 99 — see
...
**Phase 99 added quoted lines**, so nanomd is now three inline marks and one
...
The argument still holds for the other three, and 99 did not weaken it. A
...
Everything else about the design is unchanged and 99 was built to keep it that
...
Full record: [PHASE-99-QUOTE.md](PHASE-99-QUOTE.md).
