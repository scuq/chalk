...
| 83 | signed sealed envelopes + server pin, under the revised trust model (the fanout design retired at git `731eac5`) — **in progress, 83-1 … 83-6 landed** | [PHASE-83-MSGSIG.md](phases/PHASE-83-MSGSIG.md) |
